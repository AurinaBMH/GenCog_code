...
for l=1:length(DSs)
    ...
    DS = DSs(l);
    cd('/Users/Aurina/GoogleDrive/Genetics_connectome/Gen_Cog/Data/Microarray/')
    load(sprintf('%dDSExpressionCust100Uncorrected.mat', DS));
    ...
    subplot(4,1,4); imagesc(Tvals); colormap([flipud(BF_getcmap('blues',20));1,1,1;BF_getcmap('reds',20)]);
    caxis([0 30]);colorbar('southoutside');
